    ...
    <section className="min-h-screen grid grid-rows-[1fr_auto]">
      <section>
        <article>
          ...
          <h2 className="text-[#FE1936] text-center font-bold text-2xl mb-3 md:text-5xl">
            ¡Hello trainer!
          </h2>
          <p className="text-center mb-7 md:text-xl dark:text-white">
            Give me your name start:{" "}
          </p>
          <form onSubmit={handleSubmit} className="mx-auto sm:max-w-[500px]">
            <div className=" shadow-md w-[85%] max-w-[420px] mx-auto dark:border-[2px] dark:rounded-md">
              <input
                ...
                className="w-[75%] h-[30px] sm:h-[45px]"
              />
